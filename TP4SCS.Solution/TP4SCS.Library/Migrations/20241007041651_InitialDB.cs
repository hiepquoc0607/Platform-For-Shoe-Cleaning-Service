    ...
    public partial class InitialDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Account__3214EC07B6815457", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__PaymentM__3214EC07DA914CF8", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__ServiceC__3214EC07AD3F9285", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Subscrip__3214EC0759802449", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__TicketCa__3214EC07B10E6832", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__AccountA__3214EC07277C1827", x => x.Id);
                    table.ForeignKey(
                        name: "FK__AccountAd__Accou__71D1E811",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Province = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    City = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    OrderManagerIds = table.Column<string>(type: "varchar(20)", unicode: false, maxLength: 20, nullable: true),
                    EmployeeManagerIds = table.Column<string>(type: "varchar(20)", unicode: false, maxLength: 20, nullable: true),
                    CategoryManagerIds = table.Column<string>(type: "varchar(20)", unicode: false, maxLength: 20, nullable: true),
                    ServiceManagerIds = table.Column<string>(type: "varchar(20)", unicode: false, maxLength: 20, nullable: true),
                    Status = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__Business__3214EC077BDBEDF6", x => x.Id);
                    table.ForeignKey(
                        name: "FK__BusinessB__Owner__4D94879B",
                        column: x => x.OwnerId,
                        principalTable: "Account",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Business__3214EC079E653ED5", x => x.Id);
                    table.ForeignKey(
                        name: "FK__BusinessP__Owner__60A75C0F",
                        column: x => x.OwnerId,
                        principalTable: "Account",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Cart__3214EC073F946AF1", x => x.Id);
                    table.ForeignKey(
                        name: "FK__Cart__AccountId__5812160E",
                        column: x => x.AccountId,
                        principalTable: "Account",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Order__3214EC074072D21E", x => x.Id);
                    table.ForeignKey(
                        name: "FK__Order__AccountId__6383C8BA",
                        column: x => x.AccountId,
                        principalTable: "Account",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Transact__3214EC075FD4B549", x => x.Id);
                    table.ForeignKey(
                        name: "FK__Transacti__Accou__787EE5A0",
                        column: x => x.AccountId,
                        principalTable: "Account",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK__Transacti__Metho__797309D9",
                        column: x => x.MethodId,
                        principalTable: "PaymentMethod",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK__Transacti__PackI__7A672E12",
                        column: x => x.PackId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Service__3214EC07C115A187", x => x.Id);
                    table.ForeignKey(
                        name: "FK__Service__BranchI__5070F446",
                        column: x => x.BranchId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__OrderNot__3214EC07DFBB7E11", x => x.Id);
                    table.ForeignKey(
                        name: "FK__OrderNoti__Order__7D439ABD",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__SupportT__3214EC07304B71CA", x => x.Id);
                    table.ForeignKey(
                        name: "FK__SupportTi__Accou__02084FDA",
                        column: x => x.AccountId,
                        principalTable: "Account",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK__SupportTi__Categ__02FC7413",
                        column: x => x.CategoryId,
                        principalTable: "TicketCategory",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK__SupportTi__Order__03F0984C",
                        column: x => x.OrderId,
                        principalTable: "Order",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__CartItem__3214EC07AC82DD49", x => x.Id);
                    table.ForeignKey(
                        name: "FK__CartItem__CartId__5AEE82B9",
                        column: x => x.CartId,
                        principalTable: "Cart",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK__CartItem__Servic__5BE2A6F2",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__OrderDet__3214EC073D488B38", x => x.Id);
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK__OrderDeta__Servi__6754599E",
                        column: x => x.ServiceId,
                        principalTable: "Service",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Promotio__3214EC07114711A7", x => x.Id);
                    table.ForeignKey(
                        name: "FK__Promotion__Servi__534D60F1",
                        column: x => x.ServiceId,
                        principalTable: "Service",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Feedback__3214EC07886BA30E", x => x.Id);
                    table.ForeignKey(
                        name: "FK__Feedback__OrderI__6A30C649",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__AssetURL__3214EC073B92038A", x => x.Id);
                    table.ForeignKey(
                        name: "FK__AssetURL__Busine__6D0D32F4",
                        column: x => x.BusinessProfileId,
                        principalTable: "BusinessProfile",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK__AssetURL__Feedba__6E01572D",
                        column: x => x.FeedbackId,
                        principalTable: "Feedback",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK__AssetURL__Servic__6EF57B66",
                        column: x => x.ServiceId,
                        principalTable: "Service",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Account__5C7E359EF930D97A",
                table: "Account",
                column: "Phone",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UQ__Account__A9D10534C97D4C51",
                table: "Account",
                column: "Email",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Business__5C7E359EDD9E92F2",
                table: "BusinessProfile",
                column: "Phone",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UQ__Business__737584F6B46B45DC",
                table: "BusinessProfile",
                column: "Name",
                unique: true);
