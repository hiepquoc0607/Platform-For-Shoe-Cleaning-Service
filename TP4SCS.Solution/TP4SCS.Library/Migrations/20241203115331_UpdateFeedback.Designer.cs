...
namespace TP4SCS.Library.Migrations
{
    ...
    [Migration("20241203115331_UpdateFeedback")]
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.Account", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Account__3214EC0705FBE6A5");

                    b.HasIndex(new[] { "Phone" }, "UQ__Account__5C7E359ECC9764F1")
                        .IsUnique();

                    b.HasIndex(new[] { "Email" }, "UQ__Account__A9D10534B68FB54B")
                        .IsUnique();
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.AccountAddress", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__AccountA__3214EC0710C82E53");
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.AssetUrl", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__AssetURL__3214EC07C958BF8A");
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.BranchMaterial", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__BranchMa__3214EC07BF02F368");
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.BranchService", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__BranchSe__3214EC07DA0DC722");
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.BusinessBranch", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Business__3214EC07321A0486");
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.BusinessProfile", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Business__3214EC07561B7D43");

                    b.HasIndex(new[] { "Phone" }, "UQ__Business__5C7E359E4B9D863E")
                        .IsUnique();

                    b.HasIndex(new[] { "Name" }, "UQ__Business__737584F610C8C420")
                        .IsUnique();

                    b.HasIndex(new[] { "OwnerId" }, "UQ__Business__819385B9199557E6")
                        .IsUnique();
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.BusinessStatistic", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Business__3214EC07706EA099");
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.Cart", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Cart__3214EC0707397453");

                    b.HasIndex(new[] { "AccountId" }, "UQ__Cart__349DA5A77D18CEB1")
                        .IsUnique();
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.CartItem", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__CartItem__3214EC07ED8BAA42");
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.Feedback", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Feedback__3214EC079F22E21C");

                    b.HasIndex(new[] { "OrderItemId" }, "UQ__Feedback__57ED0680EE144B0F")
                        .IsUnique();
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.Leaderboard", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Leaderbo__3214EC07615F2E82");
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.Material", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Material__3214EC07411F9823");
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.Order", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Order__3214EC07EA9AB041");
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.OrderDetail", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__OrderDet__3214EC07C43E2B68");
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.OrderNotification", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__OrderNot__3214EC0794CA7B91");
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.PackSubscription", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__PackSubs__3214EC0775F44B35");
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.PlatformPack", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Platform__3214EC077D4E5070");

                    b.HasIndex(new[] { "Name" }, "UQ__Platform__737584F682BF6B58")
                        .IsUnique();
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.PlatformStatistic", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Platform__3214EC0783CE285D");
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.Promotion", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Promotio__3214EC07B3DE2EAC");

                    b.HasIndex(new[] { "ServiceId" }, "UQ__Promotio__C51BB00B136DD92B")
                        .IsUnique();
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.Service", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Service__3214EC07B31F1208");
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.ServiceCategory", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__ServiceC__3214EC076311E4B3");

                    b.HasIndex(new[] { "Name" }, "UQ__ServiceC__737584F6BC8E3A7F")
                        .IsUnique();
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.ServiceProcess", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__ServiceP__3214EC07BBB2AD47");
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.SupportTicket", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__SupportT__3214EC07A0228BF2");
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.TicketCategory", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__TicketCa__3214EC078A6B7B9F");

                    b.HasIndex(new[] { "Name" }, "UQ__TicketCa__737584F6EB5C6A88")
                        .IsUnique();
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.Transaction", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Transact__3214EC07E4C5DA61");
