...
namespace TP4SCS.Library.Migrations
{
    ...
    [Migration("20241016201049_InitialDB")]
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.Account", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Account__3214EC07BCF71952");

                    b.HasIndex(new[] { "Phone" }, "UQ__Account__5C7E359EA8D0BF1E")
                        .IsUnique();

                    b.HasIndex(new[] { "Email" }, "UQ__Account__A9D10534BA367440")
                        .IsUnique();
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.AccountAddress", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__AccountA__3214EC07EB1C6989");
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.AssetUrl", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__AssetURL__3214EC076C1DB7AE");
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.BusinessBranch", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Business__3214EC0704E00D2B");
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.BusinessProfile", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Business__3214EC071A1413A2");

                    b.HasIndex("OwnerId");

                    b.HasIndex(new[] { "Phone" }, "UQ__Business__5C7E359EF992D50A")
                        .IsUnique();

                    b.HasIndex(new[] { "Name" }, "UQ__Business__737584F6E499FE95")
                        .IsUnique();
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.Cart", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Cart__3214EC07224D07DF");
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.CartItem", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__CartItem__3214EC079FD99D0D");
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.Feedback", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Feedback__3214EC07EB07B337");
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.Order", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Order__3214EC07D7156EE7");
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.OrderDetail", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__OrderDet__3214EC07ADAEDA1B");
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.OrderNotification", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__OrderNot__3214EC07A8A79EDF");
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.PaymentMethod", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__PaymentM__3214EC070F8DFFC2");
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.Promotion", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Promotio__3214EC072136E6CE");
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.Service", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Service__3214EC0785FFAAC9");
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.ServiceCategory", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__ServiceC__3214EC0709DEE3FD");
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.Statistic", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Statisti__3214EC07247A53AF");
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.SubscriptionPack", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Subscrip__3214EC07FC7516A5");
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.SupportTicket", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__SupportT__3214EC073CF09B5E");
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.TicketCategory", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__TicketCa__3214EC0781F31285");
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.Transaction", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Transact__3214EC074D634F2F");
