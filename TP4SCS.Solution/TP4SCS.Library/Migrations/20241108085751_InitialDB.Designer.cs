...
namespace TP4SCS.Library.Migrations
{
    ...
    [Migration("20241108085751_InitialDB")]
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.Account", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Account__3214EC07C9ACB9DA");

                    b.HasIndex(new[] { "Phone" }, "UQ__Account__5C7E359EDB8A192B")
                        .IsUnique();

                    b.HasIndex(new[] { "Email" }, "UQ__Account__A9D10534348CDA74")
                        .IsUnique();
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.AccountAddress", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__AccountA__3214EC07BC4DD2F3");
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.AssetUrl", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__AssetURL__3214EC07732D0784");
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.BranchMaterial", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__BranchMa__3214EC074A95B67C");
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.BranchService", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__BranchSe__3214EC074244B97E");
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.BusinessBranch", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Business__3214EC078DC12F30");
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.BusinessProfile", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Business__3214EC07194AC4B8");

                    b.HasIndex(new[] { "Phone" }, "UQ__Business__5C7E359E0733639F")
                        .IsUnique();

                    b.HasIndex(new[] { "Name" }, "UQ__Business__737584F619DE6B28")
                        .IsUnique();

                    b.HasIndex(new[] { "OwnerId" }, "UQ__Business__819385B9C6A26C8A")
                        .IsUnique();
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.Cart", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Cart__3214EC07EA76D814");

                    b.HasIndex(new[] { "AccountId" }, "UQ__Cart__349DA5A72D636C38")
                        .IsUnique();
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.CartItem", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__CartItem__3214EC0725959601");
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.Feedback", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Feedback__3214EC07089D0130");
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.Material", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Material__3214EC0760987C54");
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.Order", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Order__3214EC07DA957CBD");
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.OrderDetail", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__OrderDet__3214EC07A868DFC7");
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.OrderNotification", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__OrderNot__3214EC07A4E9C54F");
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.PaymentMethod", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__PaymentM__3214EC07ED6922A9");

                    b.HasIndex(new[] { "Name" }, "UQ__PaymentM__737584F6C355381B")
                        .IsUnique();
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.Promotion", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Promotio__3214EC07E2416035");

                    b.HasIndex(new[] { "ServiceId" }, "UQ__Promotio__C51BB00BAFBB37E9")
                        .IsUnique();
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.Service", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Service__3214EC07C2E46723");
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.ServiceCategory", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__ServiceC__3214EC0718410B13");

                    b.HasIndex(new[] { "Name" }, "UQ__ServiceC__737584F6C12A8EE1")
                        .IsUnique();
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.ServiceMaterial", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__ServiceM__3214EC0704444BE3");
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.SubscriptionPack", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Subscrip__3214EC07F8E204EA");

                    b.HasIndex(new[] { "Name" }, "UQ__Subscrip__737584F67CEE6788")
                        .IsUnique();
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.SupportTicket", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__SupportT__3214EC072D4927ED");
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.TicketCategory", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__TicketCa__3214EC0735FC7DA7");

                    b.HasIndex(new[] { "Name" }, "UQ__TicketCa__737584F6B7C8D56A")
                        .IsUnique();
            ...
            modelBuilder.Entity("TP4SCS.Library.Models.Data.Transaction", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__Transact__3214EC07001256F3");
