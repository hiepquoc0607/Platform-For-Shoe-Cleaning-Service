...
public partial class Tp4scsDevDatabaseContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Account__3214EC07075D05B8");

            entity.ToTable("Account");

            entity.HasIndex(e => e.Phone, "UQ__Account__5C7E359EC747668A").IsUnique();

            entity.HasIndex(e => e.Email, "UQ__Account__A9D1053499EE6F64").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__AccountA__3214EC07611F27DD");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__AssetURL__3214EC07ED2078C3");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__BranchMa__3214EC0702C42453");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__BranchSe__3214EC0762A78211");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Business__3214EC071BCE949D");
            ...
            entity.HasOne(d => d.Business).WithMany(p => p.BusinessBranches)
                .HasForeignKey(d => d.BusinessId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__BusinessB__Busin__4CA06362");
        });

        modelBuilder.Entity<BusinessProfile>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Business__3214EC07656A044A");

            entity.ToTable("BusinessProfile");

            entity.HasIndex(e => e.Phone, "UQ__Business__5C7E359EBC7D34E2").IsUnique();

            entity.HasIndex(e => e.CitizenId, "UQ__Business__6E49FA0D2D455E8A").IsUnique();

            entity.HasIndex(e => e.Name, "UQ__Business__737584F6067C0CC6").IsUnique();

            entity.HasIndex(e => e.OwnerId, "UQ__Business__819385B929F28A8B").IsUnique();

            entity.Property(e => e.BackCitizenImageUrl).HasColumnType("text");
            entity.Property(e => e.CitizenId)
                .HasMaxLength(12)
                .IsUnicode(false);
            entity.Property(e => e.ExpiredTime).HasColumnType("datetime");
            entity.Property(e => e.FrontCitizenImageUrl).HasColumnType("text");
            entity.Property(e => e.ImageUrl).HasColumnType("text");
            entity.Property(e => e.Name).HasMaxLength(100);
            entity.Property(e => e.Phone)
                .HasMaxLength(10)
            ...
            entity.HasOne(d => d.Owner).WithOne(p => p.BusinessProfile)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__BusinessP__Owner__48CFD27E");
        });

        modelBuilder.Entity<Cart>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Cart__3214EC073282096D");

            entity.ToTable("Cart");

            entity.HasIndex(e => e.AccountId, "UQ__Cart__349DA5A76BF4A015").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__CartItem__3214EC07CD7F7903");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Feedback__3214EC07530E20F2");

            entity.ToTable("Feedback");

            entity.HasIndex(e => e.OrderItemId, "UQ__Feedback__57ED0680B0F74D7E").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Material__3214EC076E8E0387");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Order__3214EC07C1D28800");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__OrderDet__3214EC07E69849C9");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__OrderNot__3214EC0790B4ED58");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Promotio__3214EC07BD2A17D9");

            entity.ToTable("Promotion");

            entity.HasIndex(e => e.ServiceId, "UQ__Promotio__C51BB00BECED99B9").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Service__3214EC0773C344AD");
            ...
            entity.HasOne(d => d.Category).WithMany(p => p.Services)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Service__Categor__5441852A");
        });

        modelBuilder.Entity<ServiceCategory>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__ServiceC__3214EC07AF449616");

            entity.ToTable("ServiceCategory");

            entity.HasIndex(e => e.Name, "UQ__ServiceC__737584F69B05EB0C").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__ServiceM__3214EC0734A9829B");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Subscrip__3214EC072BE87629");

            entity.ToTable("SubscriptionPack");

            entity.HasIndex(e => e.Name, "UQ__Subscrip__737584F68C653C00").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__SupportT__3214EC078E3AFEC4");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__TicketCa__3214EC07D9293B11");

            entity.ToTable("TicketCategory");

            entity.HasIndex(e => e.Name, "UQ__TicketCa__737584F69827FE35").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Transact__3214EC07D33916C6");
            ...
            entity.HasOne(d => d.Account).WithMany(p => p.Transactions)
                .HasForeignKey(d => d.AccountId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Transacti__Accou__1CBC4616");

            entity.HasOne(d => d.Pack).WithMany(p => p.Transactions)
                .HasForeignKey(d => d.PackId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Transacti__PackI__1DB06A4F");
        });
